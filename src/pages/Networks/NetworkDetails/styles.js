...
export const WrapperNetworkDetails = styled.div`
  display: flex;
...
export const ContentNetworkDetails = styled.div`
  display: flex;
  flex-direction: column;
  gap: 1rem;
`;
...
export const HeaderPageClinics = styled.header`
  display: flex;
  flex-direction: column;
  align-items: start;
  gap: 0.75rem;
...
export const BoxClinics = styled.div`
  display: flex;
  flex-direction: column;
  gap: 0.75rem;
`;
...
export const TitleClinics = styled.span`
  font-weight: bold;
  font-size: ${({ theme }) => theme.fontSize.lg};
`;
